...
namespace ql_thu_vien
{
    public partial class CuonSach : Form
    {
        ...
        private void CuonSach_Load(object sender, EventArgs e)
        {
            ...
            cbxtentg.DataSource = Bus.GetListtacgia();
            cbxtentg.ValueMember = "tentg";
            ...
            dgvThongtinCS.Columns["tentg"].HeaderText = "Tên Tác Giả";
            dgvThongtinCS.Columns["coluongcon"].HeaderText = "Số Lượng Còn";
        }
        ...
        private void tsbAdd_Click(object sender, EventArgs e)
        {
            ...
            txtsoluongcon.Text = string.Empty;
        }
        ...
        private void tsbSave_Click(object sender, EventArgs e)
        {
            ...
            cs.tentg = cbxtentg.Text;
            cs.coluongcon = txtsoluongcon.Text;
        ...
        private void dgvThongtinCS_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbxtentg.Text= dgvThongtinCS.CurrentRow.Cells["tentg"].Value.ToString();
            txtsoluongcon.Text= dgvThongtinCS.CurrentRow.Cells["coluongcon"].Value.ToString();
        }
